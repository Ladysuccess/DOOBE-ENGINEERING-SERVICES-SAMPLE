...
:root {
    ...
    --shadow: 0 20px 60px rgba(8, 16, 51, 0.12);
...
.btn.red {
    ...
    box-shadow: 0 12px 28px rgba(230, 55, 53, 0.20);
}
...
.contact textarea:focus {
    ...
    box-shadow: 0 0 0 3px rgba(230, 55, 53, 0.08);
}
...
@media (prefers-reduced-motion: reduce) {
    ...
    *::after {
        ...
        animation-iterattion-count: 1 !important;
